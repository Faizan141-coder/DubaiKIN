  ...
  return (
    <>
        ...
        <div className='flex bg-orange-400'>
            ...
            <div className="w-full h-[900px] pl-28">
            ...
            {/* Box */}
            <div className="h-[680px] bg-white rounded mt-28 mr-28 p-5">
                <div className="text-black text-opacity-80 text-center text-xl font-semibold">Withdraw Money</div>
                ...
                <div className="text-orange-400 mt-5 text-xs font-medium">Click here and draw your signature</div>

                <button onClick={() => router.push('/signature')} className="w-80 h-7 bg-blue-950 bg-opacity-50">
                    <h1 className="text-white text-xs font-medium">Digital Signature</h1>
                </button>
                ...
                <button className="w-full h-8 mt-5 bg-blue-950 rounded">
                    <h1 className="text-white text-sm font-semibold">Edit</h1>
                </button>

                <button className="w-full h-8 mt-1 bg-blue-950 rounded">
                    <h1 className="text-white text-sm font-semibold">Withdraw</h1>
                </button>
            </div>
