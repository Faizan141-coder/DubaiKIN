            ...
            <div className="w-full h-[1000px] relative bg-neutral-100">
                ...
                <div className="w-64 h-96 left-[16px] top-[20px] absolute">
                    <div className="w-64 h-[460px] left-0 top-0 absolute bg-white rounded-2xl" />
                        ...
                        <div className="w-64 h-10 left-0 top-[168px] absolute cursor-pointer">
                            <div className="w-52 h-10 left-[24px] top-[6px] absolute bg-blue-100 rounded">
                                <Image 
                                    src="/calendar-orange.png"
                                    width={24}
                                    height={24}
                                    alt="Calendar"
                                    className='mt-2 ml-2'
                            ...
                            <div className="w-36 h-4 left-[86px] top-[16px] absolute text-orange-400 text-sm font-medium leading-tight tracking-tight">Calendar</div>
                        </div>
