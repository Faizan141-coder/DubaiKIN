  ...
  return (
    <>
        ...
        <div className='flex bg-orange-400 items-center justify-center'>
            ...
            <div className="w-96 h-[950px]">
                {/* Box */}
                <div className="h-[730px] bg-white rounded mt-28  p-5">
                    <Image 
                        src="/image 4.svg" 
                        width={200} 
                        className='ml-14' 
                    ...
                    <h1 className="text-orange-400 my-2 text-xs font-medium">Id Card</h1>
                    ...
                    <button onClick={() => router.push('/receive-money-5')} className="w-full h-8 mt-5 bg-blue-950 rounded">
