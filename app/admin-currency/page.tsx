        ...
        <div>
            ...
            <div className="w-full h-[1000px] relative bg-neutral-100">
                ...
                <div className="w-64 h-96 left-[16px] top-[20px] absolute">
                    ...
                    <div onClick={() => router.push('/admin')} className="w-64 h-10 left-0 top-[25px] absolute cursor-pointer">
                    ...
                    <div onClick={() => router.push('/admin-people')} className="w-64 h-10 left-0 top-[70px] absolute cursor-pointer">
                    ...
                    <div onClick={() => router.push('/admin-transactions')} className="cursor-pointer w-64 h-10 left-0 top-[216px] absolute">
                        ...
                        <div className="w-36 h-4 left-[86px] top-[16px] absolute text-sm font-medium leading-tight tracking-tight">Transactions</div>
                    </div>
                    ...
                    <div className="w-64 h-10 left-0 top-[305px] absolute cursor-pointer">
                        <div className="w-52 h-10 left-[24px] top-[6px] absolute bg-blue-100 rounded">
                            <Image 
                                src="/currency-orange.png"
                                width={24}
                                height={24}
                                alt="Currency Setup"
                                className='mt-2 ml-2'
                        ...
                        <div className="w-36 h-4 left-[86px] top-[16px] absolute text-orange-400 text-opacity-90 text-sm font-medium leading-tight tracking-tight">Currency Setup</div>
                    </div>
