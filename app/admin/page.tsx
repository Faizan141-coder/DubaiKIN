        ...
        <div>
            ...
            <div className="w-full h-[1000px] relative bg-neutral-100">
                ...
                <div className="w-64 h-96 left-[16px] top-[20px] absolute">
                    ...
                    <div onClick={() => router.push('/admin-people')} className="w-64 h-10 left-0 top-[72px] absolute cursor-pointer">
                    ...
                    <div onClick={() => router.push('/admin-transfer')} className="w-64 h-10 left-0 top-[120px] absolute cursor-pointer">
                        <div className="w-6 h-6 left-[38px] top-[8px] absolute" />
                            <Image 
                                src="/transfer.svg"
                                width={24}
                    ...
                    <div onClick={() => router.push('/admin-calendar')} className="w-64 h-10 left-0 top-[168px] absolute cursor-pointer">
                        <Image 
                            src="/calendar.svg"
                            width={24}
                            height={24}
                    ...
                    <div onClick={() => router.push('/admin-transactions')} className="w-64 h-10 left-0 top-[216px] absolute cursor-pointer">
                        <Image 
                    ...
                    <div className="w-64 h-10 left-0 top-[264px] absolute cursor-pointer">
                        <Image 
                            src="/fees.svg"
                            width={24}
                            height={24}
                    ...
                    <div onClick={() => router.push('/admin-currency')} className="w-64 h-10 left-0 top-[312px] absolute cursor-pointer">
                        <Image 
                            src="/currency.svg"
                            width={24}
                            height={24}
                ...
                {/* Add Widget Button */}
                <button className="w-32 h-10 left-[1210px] top-[20px] absolute">
                    <div className="w-32 h-10 left-0 top-0 absolute bg-green-500 rounded-2xl shadow border border-green-500" />
                    <div className="w-6 h-6 left-[16px] top-[8px] absolute">
                    </div>
                    <div className="w-24 h-6 left-[17px] top-[11px] absolute text-center text-white text-sm font-bold leading-tight tracking-tight">ADD WIDGET
                    </div>
                </button>
                
                {/* Transaction Box */}
                <div className="w-96 h-96 left-[288px] top-[20px] absolute">
                    <div className="w-[450px] h-[465px] left-0 top-0 absolute bg-white rounded-2xl" />
                    ...
                    <div className="w-28 h-5 left-[258px] top-[392px] absolute">
                        ...
                        <h1 className="w-full left-[24px] top-0 absolute text-black text-sm font-normal leading-tight tracking-wide">San Francisco</h1>
                    </div>
                ...
                {/* Statistics Box */}
                <div className="w-96 h-96 left-[750px] top-[20px] absolute">
                    <div className="w-[450px] h-[465px] left-0 top-0 absolute bg-white rounded-2xl" />
                    ...
                    <div className="w-36 h-4 left-[112px] top-[360px] absolute">
                        ...
                        <div className="w-full h-4 left-[24px] top-0 absolute text-black text-sm font-normal leading-tight tracking-wide">FIAT-Chrysler LLC</div>
                    </div>
                    ...
                    <div className="w-36 h-5 left-[120px] top-[395px] absolute">
                        ...
                        <div className="w-full left-[24px] top-0 absolute text-black text-sm font-normal leading-tight tracking-wide">American Express</div>
                    </div>
                ...
                {/* Assigned Risks Box */}
                <div className="w-96 h-96 left-[288px] top-[500px] absolute">
                    <div className="w-[450px] h-[465px] left-0 top-0 absolute bg-white rounded-2xl" />
                ...
                <div className="w-96 h-96 left-[750px] top-[500px] absolute">
                    <div className="w-[450px] h-[465px] left-0 top-0 absolute bg-white rounded-2xl" />
